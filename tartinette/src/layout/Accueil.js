                ...
                <div className="main_content">
                    ...
                    <div className="accueilParagraphe2">
                        <div className="iconeParagraphe">
                            <img className="responsive-img frigo" src={frigo} alt="image frigo" />
                            <h4 className="textInColor">Frigo vide?</h4>
                            <p>Le jambon est vert? Le pain est poilu? <br/>
                                La salade est blette? Pas de soucis!</p>
                        </div>
                        <div className="iconeParagraphe">
                            <img className="responsive-img ordinateur" src={ordinateur} alt="image ordinateur" />
                        ...
                        <div className="iconeParagraphe">
                            <img className="boitetartines" src={boiteatartines} alt="image boite à tartines" />
                        ...
                        <div className="iconeParagraphe">
                            <img className="tartine" src={tartine} alt="image tartin" />
                    ...
                    <div className="accueilParagraphe3">
                        <img className="responsive-img logo_ecole_saint_henri" src={logo_ecole_saint_henri} alt="logo_ecole_saint_henri" />
                    </div>
                    <Footer/>
                </div>
            </div>
